...
!!! note
    For this part of the tutorial, you should have an NFS server already configured. If not, please follow the first chapter of [this tutorial](/advanced/{{ abcdesktop.latest_release }}/storage/nfs#set-up-a-nfs-server).
