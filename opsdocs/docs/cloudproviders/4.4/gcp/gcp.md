...
For more details about the command parameters, see the [gcloud container clusters create documentation](https://docs.cloud.google.com/sdk/gcloud/reference/container/clusters/create).
