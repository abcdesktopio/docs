...
Configure abcdesktop to use Keycloak as the authentication provider by updating the `od.config` file as described on [this page](https://www.abcdesktop.io/advanced/{{ abcdesktop.latest_release }}/authentication/authexternal/#keycloak-oauth).
