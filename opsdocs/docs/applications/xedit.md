# xedit
![circle_xedit.svg](icons/circle_xedit.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output xedit.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xedit.d.3.0.json
...
USER root
RUN apk add --no-cache --update xedit
...
[Dockerfile for application xedit](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xedit.d)
``` sh
