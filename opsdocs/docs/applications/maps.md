# maps
![org.gnome.Maps.svg](icons/org.gnome.Maps.svg){: style="height:64px;width:64px"}
## inherite from
...
[Dockerfile for application maps](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/maps.d)
``` sh
