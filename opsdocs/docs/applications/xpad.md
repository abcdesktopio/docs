...
``` sh
ABCHOST=localhost
curl --output xpad.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xpad.d.3.0.json
...
[Dockerfile for application xpad](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xpad.d)
``` sh
