# inkscape
![circle_inkscape.svg](icons/circle_inkscape.svg){: style="height:64px;width:64px"}
## inherite from
...
``` json
{
    ...
    "cat": "graphics",
    "debpackage": "numix-gtk-theme gtk2-engines gtk2-engines-pixbuf libgtk2.0-0 inkscape",
    "icon": "circle_inkscape.svg",
    "keyword": "inkscape",
    "launch": "inkscape.Inkscape",
    "name": "inkscape",
    ...
    "mimetype": "image/svg+xml;image/svg+xml-compressed;application/vnd.corel-draw;application/illustrator;",
    "fileextensions": "ai;cdr",
    "legacyfileextensions": "ai;cdr",
    "installrecommends": true,
    "desktopfile": "/usr/share/applications/inkscape.desktop"
}
```
...
``` sh
ABCHOST=localhost
curl --output inkscape.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/inkscape.d.3.0.json
...
[Dockerfile for application inkscape](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/inkscape.d)
``` sh
