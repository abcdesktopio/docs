...
``` json
{
    ...
    "cat": "games",
    "apkpackage": "gnuchess gnome-chess dbus",
...
``` sh
ABCHOST=localhost
curl --output chess.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/chess.d.3.0.json
