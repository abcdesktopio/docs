...
``` 
/usr/share/applications/org.pantheon.calculator.desktop
```
...
``` json
{
    ...
    "debpackage": "pantheon-calculator dbus-x11",
    "bindhomevolume": "False",
    "icon": "circle_calculator.svg",
    "keyword": "calculator",
    "launch": "io.elementary.calculator.Io.elementary.calculator",
    "name": "Calculator",
    "path": "/usr/bin/io.elementary.calculator",
    "template": "abcdesktopio/oc.template.ubuntu.gtk.18.04",
    "mimefilename": "pantheon-calculator",
    "host_config": {
        "mem_limit": "64M",
        "shm_size": "0M",
        "pid_mode": false
    },
    "desktopfile": "/usr/share/applications/org.pantheon.calculator.desktop",
    "preruncommands": [
        "RUN add-apt-repository ppa:elementary-os/stable"
    ]
}
...
``` sh
ABCHOST=localhost
curl --output Calculator.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Calculator.d.3.0.json
