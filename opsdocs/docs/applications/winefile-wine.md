# winefile-wine
![winefile.svg](icons/winefile.svg){: style="height:64px;width:64px"}
## inherite from
...
``` json
{
    ...
    "apkpackage": "wine",
    "icon": "winefile.svg",
    "keyword": "wine,winefile,file,manager",
...
``` sh
ABCHOST=localhost
curl --output winefile-wine.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winefile-wine.d.3.0.json
...
LABEL oc.keyword="winefile-wine,wine,winefile,file,manager"
...
ENV APPBIN "/usr/bin/winfile"
ENV APP "/usr/bin/winfile"
USER root
...
[Dockerfile for application winefile-wine](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winefile-wine.d)
``` sh
