# corsix-th
![games.svg](icons/games.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output corsix-th.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/corsix-th.d.3.0.json
...
[Dockerfile for application corsix-th](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/corsix-th.d)
``` sh
