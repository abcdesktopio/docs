# base
![circle_libreoffice_base.svg](icons/circle_libreoffice_base.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output base.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/base.d.3.0.json
...
[Dockerfile for application base](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/base.d)
``` sh
