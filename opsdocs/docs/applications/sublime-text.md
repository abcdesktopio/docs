...
``` sh
ABCHOST=localhost
curl --output sublime-Text.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/sublime-Text.d.3.0.json
...
[Dockerfile for application sublime-Text](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/sublime-Text.d)
``` sh
