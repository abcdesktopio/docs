# Bless
![circle_bless.svg](icons/circle_bless.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output Bless.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Bless.d.3.0.json
