# openshift
![openshift.svg](icons/openshift.svg){: style="height:64px;width:64px"}
## inherite from
...
curl -X PUT -H 'Content-Type: text/javascript' http://localhost:30443/API/manager/image -d @openshift.json
```
