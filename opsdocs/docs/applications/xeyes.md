# xeyes
![circle_xfce4-eyes.svg](icons/circle_xfce4-eyes.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output xeyes.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xeyes.d.3.0.json
...
[Dockerfile for application xeyes](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xeyes.d)
``` sh
