...
``` sh
ABCHOST=localhost
curl --output konsole.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/konsole.d.3.0.json
...
USER root
RUN apk add --no-cache --update konsole
...
LABEL oc.keyword="konsole,xterm,shell,cmd"
