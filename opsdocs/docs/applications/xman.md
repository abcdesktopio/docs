...
``` sh
ABCHOST=localhost
curl --output xman.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xman.d.3.0.json
...
[Dockerfile for application xman](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/xman.d)
``` sh
