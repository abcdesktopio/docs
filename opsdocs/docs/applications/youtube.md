# youtube
![circle_youtube.svg](icons/circle_youtube.svg){: style="height:64px;width:64px"}
## inherite from
...
curl -X PUT -H 'Content-Type: text/javascript' http://localhost:30443/API/manager/image -d @youtube.json
```
