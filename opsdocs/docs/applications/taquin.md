# taquin
![org.gnome.Taquin.svg](icons/org.gnome.Taquin.svg){: style="height:64px;width:64px"}
## inherite from
...
[Dockerfile for application taquin](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/taquin.d)
``` sh
