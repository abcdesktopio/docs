# winemine-wine
![winemine.svg](icons/winemine.svg){: style="height:64px;width:64px"}
## inherite from
...
``` json
{
    ...
    "apkpackage": "wine",
    "icon": "winemine.svg",
    "keyword": "wine,winemine",
    "launch": "winemine.exe.Wine",
    "name": "winemine-wine",
...
``` sh
ABCHOST=localhost
curl --output winemine-wine.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winemine-wine.d.3.0.json
...
LABEL oc.keyword="winemine-wine,wine,winemine"
LABEL oc.cat="games"
LABEL oc.launch="winemine.exe.Wine"
...
[Dockerfile for application winemine-wine](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/winemine-wine.d)
``` sh
