# Gedit
![gedit.svg](icons/gedit.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output Gedit.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Gedit.d.3.0.json
