# jupyternvidia
![jupyter.svg](icons/jupyter.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output jupyternvidia.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/jupyternvidia.d.3.0.json
