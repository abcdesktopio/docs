# Evince
![circle_acroread.svg](icons/circle_acroread.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output Evince.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Evince.d.3.0.json
...
[Dockerfile for application Evince](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Evince.d)
``` sh
