...
``` json
{
    ...
    "cat": "development",
    "debpackage": "at-spi2-core gnome-terminal dbus-x11",
...
``` sh
ABCHOST=localhost
curl --output terminalpod.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/terminalpod.d.3.0.json
...
LABEL oc.keyword="terminalpod,pod,shell"
...
[Dockerfile for application terminalpod](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/terminalpod.d)
``` sh
