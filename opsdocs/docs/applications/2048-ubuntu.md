...
``` sh
ABCHOST=localhost
curl --output 2048-ubuntu.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/2048-ubuntu.d.3.0.json
...
[Dockerfile for application 2048-ubuntu](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/2048-ubuntu.d)
``` sh
