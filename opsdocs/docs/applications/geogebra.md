# Geogebra
![geogebra.svg](icons/geogebra.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output Geogebra.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Geogebra.d.3.0.json
