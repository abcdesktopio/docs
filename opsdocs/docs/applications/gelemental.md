# gElemental
![gelemental.svg](icons/gelemental.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output gElemental.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gElemental.d.3.0.json
...
[Dockerfile for application gElemental](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/gElemental.d)
``` sh
