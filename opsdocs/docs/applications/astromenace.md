...
``` sh
ABCHOST=localhost
curl --output astromenace.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/astromenace.d.3.0.json
...
[Dockerfile for application astromenace](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/astromenace.d)
``` sh
