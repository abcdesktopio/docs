...
``` sh
ABCHOST=localhost
curl --output cuda.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/cuda.d.3.0.json
...
[Dockerfile for application cuda](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/cuda.d)
``` sh
