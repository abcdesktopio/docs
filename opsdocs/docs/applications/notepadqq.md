# notepadqq
![notepadqq.svg](icons/notepadqq.svg){: style="height:64px;width:64px"}
## inherite from
...
[Dockerfile for application notepadqq](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/notepadqq.d)
``` sh
...
curl -X PUT -H 'Content-Type: text/javascript' http://localhost:30443/API/manager/image -d @notepadqq.json
```
