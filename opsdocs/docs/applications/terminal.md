...
## inherite from
[abcdesktopio/oc.template.ubuntu.minimal.20.04](../abcdesktopio/oc.template.ubuntu.minimal.20.04)
## Distribution
...
COPY composer/init.d/init.gnome-terminal /composer/init.d/init.gnome-terminal
```
...
``` sh
ABCHOST=localhost
curl --output Terminal.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Terminal.d.3.0.json
...
[Dockerfile for application Terminal](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Terminal.d)
``` sh
