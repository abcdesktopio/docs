...
``` sh
ABCHOST=localhost
curl --output Gimp.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Gimp.d.3.0.json
...
[Dockerfile for application Gimp](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Gimp.d)
``` sh
