...
``` sh
ABCHOST=localhost
curl --output Kgeography.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Kgeography.d.3.0.json
...
[Dockerfile for application Kgeography](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/Kgeography.d)
``` sh
