...
``` sh
ABCHOST=localhost
curl --output 2048-alpine.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/2048-alpine.d.3.0.json
...
[Dockerfile for application 2048-alpine](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/2048-alpine.d)
``` sh
