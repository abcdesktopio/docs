# powershell
![powershell.svg](icons/powershell.svg){: style="height:64px;width:64px"}
## inherite from
...
[Dockerfile for application powershell](https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/powershell.d)
``` sh
