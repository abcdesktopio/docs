# postman
![circle_postman.svg](icons/circle_postman.svg){: style="height:64px;width:64px"}
## inherite from
...
``` sh
ABCHOST=localhost
curl --output postman.json https://raw.githubusercontent.com/abcdesktopio/oc.apps/main/postman.d.3.0.json
