...
The following is an example of a `firefox.d.{{ abcdesktop.latest_release }}.json` OCI image descriptor file, as generated by `docker inspect`:
...
[
    {
        ...
        "RepoTags": [
            "ghcr.io/abcdesktopio/firefox.d:{{ abcdesktop.latest_release }}"
        ],
        "RepoDigests": [
