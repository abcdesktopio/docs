...
```PowerShell
$script = curl https://raw.githubusercontent.com/abcdesktopio/conf/main/kubernetes/uninstall-4.2.ps1 
...
```PowerShell
curl https://raw.githubusercontent.com/abcdesktopio/conf/main/kubernetes/uninstall-4.2.ps1  -OutFile uninstall-4.2.ps1
```

Run the `uninstall-4.2.ps1` command line with your own namespace

```PowerShell
.\uninstall-4.2.ps1 --namespace superdesktop
```
