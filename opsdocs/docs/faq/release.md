...
|---|---|---|---|---|---|
| 5.0 | dev | 2027-01-01 | Kubernetes >= 1.24, any container runtime | Applications run as pods or ephemeral containers; MPEG audio support | work in progress |
| 4.4 | Stable | 2026-06-01 | Kubernetes >= 1.24, any container runtime | Applications run as pods or ephemeral containers; MPEG audio support | Released |
...
| 4.2 | Deprecated | 2025-06-01 | Kubernetes >= 1.24, any container runtime | Applications run as pods or ephemeral containers; MPEG audio support | Released |
