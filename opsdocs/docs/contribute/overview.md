...
<!--
    ...
    1. Simplified Maintenance: Regular updates provided by Ubuntu ensure that your system remains up-to-date and secure. Consequently, by using Ubuntu packages for abcdesktop
    deployments, you can be confident that your system remains healthy throughout its lifecycle.
    2. Rapid Deployment: Ubuntu packages are available through official Ubuntu repositories and can easily be installed on any Linux system that uses Apt or aptitude. This reduces the time
    required to deploy a new abcdesktop system to just one step.
    3. Collaboration with the Community: By using Ubuntu packages for deployments, you contribute to the Ubuntu community and its package ecosystem. This allows all members of the
    community to use and share the same tools and resources, facilitating collaboration and knowledge sharing.
    4. Predefined and optimized: The Ubuntu packages are predefined and optimized for various deployment scenarios, ensuring that your system functions effectively throughout its
    lifecycle.
    5. Quality Guarantee: The Ubuntu packages have been tested and approved by the Ubuntu developers before publication, ensuring a certain level of quality and reliability for
    abcdesktop deployments.
    6. Resources Available: Resources for creating Ubuntu packages are available to all members of the community, allowing you to learn, share, and collaborate with other developers.
    7. Regular Updates: Regular updates provided by Ubuntu ensure that the packages remain current and secure. By using Ubuntu packages for abcdesktop deployments, you can be confident
    that your system remains healthy throughout its lifecycle.

    By using Ubuntu packages for abcdesktop deployments, we enable all community members to use a stable and secure operating system, with simplified and optimized maintenance for
...
<!--
??? success must "All packages must be deployed on YourDev package repository"
    to be done

    To ensure that abcdesktop users have access to a wide range of up-to-date and tested software packages, we recommend that all abcdesktop packages be included in the YourDev
    Linux Package Repository. By including all packages, the YourDev repository, you will benefit from several advantages:

    1. Regular Updates: The repository is continuously updated to include the latest versions of popular applications, ensuring that users always have access to the most current software.
    2. Quality Guarantee: All packages included in the repository are thoroughly tested and vetted by the abcdesktop development team, ensuring that they meet our quality standards and work
    seamlessly with the operating system.
    3. Easy Accessibility: By providing a centralized location for all abcdesktop packages, users can easily access and install software directly from their system without having to
    manually download and install each package individually.
    4. Cooperation with the Community: The repository is open-source and community-driven, allowing members of the abcdesktop community to contribute and collaborate on the development of new
    packages for the repository.
    5. Consistency: By using the repository as a single source for all abcdesktop packages, we ensure consistency in naming conventions, dependencies, and installation procedures across all
    packages.
    6. Efficient Upgrades: By using the repository to manage your package updates, you can easily upgrade your system to the latest version of abcdesktop without having to manually update
    each individual package.
    7. Improved Security: The repository uses strong security measures to prevent malicious or outdated packages from being included in the repository, protecting users from potential
    vulnerabilities and risks.
    8. Customization: Users can easily customize their installation by selecting which packages they want to include during the installation process, rather than having to manually install
    each package individually.

    By including all abcdesktop packages within the repository, we ensure that users have easy access to a wide range of up-to-date and tested software packages, while also ensuring
    consistency, security, and efficiency in the deployment and management of their systems. We encourage all developers to contribute to the repository to help expand its offerings and improve
    the overall experience for abcdesktop users.
-->
??? success should "Every feature should be in Github abcdesktop organisation"
    To facilitate collaboration and ensure efficient development of abcdesktop features, we recommend that all abcdesktop feature projects be hosted in the abcdesktop Github organisation for
    working on individual tasks and features. By hosting all feature projects within the abcdesktop Github organisation, you will benefit from several advantages:
