...
In this example, we install the application `2048` game, but you can choose another one from [https://github.com/abcdesktopio/images/tree/main/artifact/3.2](https://github.com/abcdesktopio/images/tree/main/artifact/3.2)
