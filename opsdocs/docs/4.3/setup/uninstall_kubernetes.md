...
# Command to uninstall abcdesktop release 4.3

To uninstall abcdesktop. Choose run run the `uninstall-4.3.sh` bash script using a curl.
...
```bash
wget https://raw.githubusercontent.com/abcdesktopio/conf/main/kubernetes/uninstall-4.3.sh
chmod 755 uninstall-4.3.sh
```

Run the `uninstall-4.3.sh` command line with your own namespace

```
./uninstall-4.3.sh --namespace superdesktop
```
