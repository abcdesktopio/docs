...
```PowerShell
$script = curl https://raw.githubusercontent.com/abcdesktopio/conf/main/kubernetes/uninstall-{{ version }}.ps1 
...
```PowerShell
curl https://raw.githubusercontent.com/abcdesktopio/conf/main/kubernetes/uninstall-{{ version }}.ps1  -OutFile uninstall-{{ version }}.ps1
```

Run the `uninstall-{{ version }}.ps1` command line with your own namespace

```PowerShell
.\uninstall-{{ version }}.ps1 --namespace superdesktop
```
